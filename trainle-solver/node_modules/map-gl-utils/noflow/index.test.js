...
describe('step()', () => {
    test('Makes a step function with a string property', () => {
        const e = utils.step('size', 8, { 2: 15, 4: 30 });
        expect(e).toEqual(['step', ['get', 'size'], 8, 2, 15, 4, 30]);
    });
    test('Makes a step function with an expression', () => {
        const e = utils.step(['get', 'size'], 8, { 2: 15, 4: 30 });
        expect(e).toEqual(['step', ['get', 'size'], 8, 2, 15, 4, 30]);
    });
    test('Makes a step function with an expression and numbers', () => {
        const e = utils.step(['get', 'size'], 8, 2, 15, 4, 30);
        expect(e).toEqual(['step', ['get', 'size'], 8, 2, 15, 4, 30]);
    });
    test('Makes a step function with a string property and just one value', () => {
        const e = utils.step('size', 8, 2, 15);
        expect(e).toEqual(['step', ['get', 'size'], 8, 2, 15]);
    });
});

describe('stepZoom()', () => {
    test('Makes a step zoom function with numbers', () => {
        const e = utils.stepZoom('small-icon', 15, 'big-icon');
        expect(e).toEqual(['step', ['zoom'], 'small-icon', 15, 'big-icon']);
    });
});
