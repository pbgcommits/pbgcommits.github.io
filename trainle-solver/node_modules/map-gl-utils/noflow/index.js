...
class MapGlUtils                       {
    ...
    */
    ...
    static async newMap(
        mapboxgl             ,
        params                            = {}, //hrm should be MapOptions but that type seems incomplete?
        options    
    ...
    static step(expression, lowest, stops, ...moreStops) {
        return [
            'step',
            typeof expression === 'string' ? ['get', expression] : expression,
            lowest,
    ...
    static interpolateZoom(stops, ...moreStops) {
        return this.interpolate(['zoom'], stops, ...moreStops);
    }

    static stepZoom(stops, ...moreStops) {
        return this.step(['zoom'], stops, ...moreStops);
    }
    ...
    */
    ...
    setLayerStyle                         = arrayify(function (
        layer                                ,
        style         
    ) {
    ...
    */
    ...
    @param {boolean} state True for visible, false for hidden.*/
    toggleSource                          = arrayify(function (
        sourceId,
        state
    ) {
        this.setVisibility(
    ...
    */
     ...
     *
     */
    setLayerSource                                = arrayify(function (
        layerId,
        source,
        sourceLayer
    ) {
